  ...
  return (
    <div className="demo-shell px-4 py-16 sm:px-6 lg:px-8">
      <section className="mx-auto max-w-2xl border border-protect/60 bg-canvas p-6 sm:p-8">
        ...
        <button type="button" onClick={reset} className="mt-7 min-h-11 border border-signal bg-signal px-4 font-data text-xs font-semibold uppercase tracking-[0.06em] text-black transition-colors duration-100 ease-tinjau hover:bg-signal-soft active:translate-y-px">Retry walkthrough</button>
      </section>
    </div>
  );
}
