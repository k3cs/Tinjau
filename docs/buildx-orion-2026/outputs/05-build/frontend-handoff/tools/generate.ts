...
write("deployed-addresses.json", {
  ...
  statusText:
    "THESE ARE T4.2 WORKING ADDRESSES, NOT THE FINAL LIST. T7.2 re-verifies and owns the " +
    "authoritative set. Do not hardcode them into anything a judge will see without checking " +
    "with the non-frontend lane first.",
